...
public class AddStationScreenHandler extends BaseScreenHandler implements Initializable {
	...
	public AddStationScreenHandler(Stage stage, String screenPath, BaseScreenHandler screen) throws IOException {
		super(stage, screenPath);
		this.screen = screen;
	}
		...
		try {
			...
			if (res >= 0) {
				BaseScreenHandler resultScreen = new ResultScreenHandler(this.stage, Configs.RESULT_SCREEN_PATH,
						"ADD STATION RESULT", "ADD SUCCESSFULLY", "ADD STATION");
				resultScreen.setPreviousScreen(this);
				resultScreen.setScreenTitle("Result Screen");
				resultScreen.show();
			}
		} catch (NumberFormatException ex) {
			JOptionPane.showMessageDialog(null, "Field must be number!");
		} catch (Exception e) {
